...
<h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Kendaraan</h1>

<div class="bg-white p-8 rounded-lg shadow-md max-w-lg mx-auto">
    <form action="index.php?page=kendaraan&action=edit&id=<?= htmlspecialchars($data['id_kendaraan']) ?>" method="POST">
        <div class="mb-4">

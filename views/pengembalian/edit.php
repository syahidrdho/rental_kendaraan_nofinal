...
<h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Data Pengembalian</h1>
...
<div class="bg-white p-8 rounded-lg shadow-md">
    <form method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="date" id="tgl_dikembalikan" name="tgl_dikembalikan" value="<?= htmlspecialchars($data['tgl_dikembalikan']) ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
        <div class="mb-4">
            <label for="denda" class="block text-gray-700 text-sm font-bold mb-2">Denda (Rp)</label>
            <input type="number" step="1000" id="denda" name="denda" value="<?= htmlspecialchars($data['denda']) ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
